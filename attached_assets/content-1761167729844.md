...
Connect your website with Outrank using our webhook integration
...
- **event\_type:** The type of event that occurred ( always " **publish\_articles**" in this case).
...
- **content\_markdown:** The article content in Markdown format.
- **content\_html:** The article content in HTML format.
- **meta\_description:** A brief description of the article for SEO purposes.
- **created\_at:** The timestamp when the article was created (ISO 8601 format).
- **image\_url:** The URL of the main image associated with the article.
...
If you don't receive the webhook, check your endpoint URL, access token configuration, and ensure your server is publicly accessible via HTTPS.
...
[Contact our support team for any questions or issues with your webhook integration](mailto:support@outrank.so)

Let's Try!

## Start creating magic today with a free trial!

[Get Started for Free![btn arrow](https://www.outrank.so/_next/static/media/black-arrow.9f2fcb29.svg)](https://www.outrank.so/signin)